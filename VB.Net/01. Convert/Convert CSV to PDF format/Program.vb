...
Namespace Example
	Friend Class Program
		...
		''' <summary>
		''' Convert CSV to PDF (file to file).
		''' </summary>
		''' <remarks>
		''' Details: https://sautinsoft.com/products/excel/help/net/developer-guide/convert-csv-to-pdf-in-csharp-vb.php
		''' </remarks>
		...
		''' <summary>
		''' Convert CSV to PDF (using Stream).
		''' </summary>
		''' <remarks>
		''' Details: https://sautinsoft.com/products/excel/help/net/developer-guide/convert-csv-to-pdf-in-csharp-vb.php
		''' </remarks>
