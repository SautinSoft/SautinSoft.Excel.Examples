...
Namespace Example
	Friend Class Program
		...
		''' <summary>
		''' Convert XLS to DOCX (file to file).
		''' </summary>
		''' <remarks>
		''' Details: https://sautinsoft.com/products/excel/help/net/developer-guide/convert-xls-to-docx-in-csharp-vb.php
		''' </remarks>
		...
		''' <summary>
		''' Convert XLS to DOCX (using Stream).
		''' </summary>
		''' <remarks>
		''' Details: https://sautinsoft.com/products/excel/help/net/developer-guide/convert-xls-to-docx-in-csharp-vb.php
		''' </remarks>
