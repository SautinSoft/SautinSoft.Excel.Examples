...
Namespace Example
	Friend Class Program
		...
		''' <summary>
		''' Convert XLSX to CSV (file to file).
		''' </summary>
		''' <remarks>
		''' Details: https://sautinsoft.com/products/excel/help/net/developer-guide/convert-xlsx-to-csv-in-csharp-vb.php
		''' </remarks>
		...
		''' <summary>
		''' Convert XLSX to CSV (using Stream).
		''' </summary>
		''' <remarks>
		''' Details: https://sautinsoft.com/products/excel/help/net/developer-guide/convert-xlsx-to-csv-in-csharp-vb.php
		''' </remarks>
		Private Shared Sub ConvertFromStream()
			...
			Dim inpFile As String = "..\..\..\Example.xlsx"
			Dim outFile As String = "..\..\..\ResultStream.csv"
