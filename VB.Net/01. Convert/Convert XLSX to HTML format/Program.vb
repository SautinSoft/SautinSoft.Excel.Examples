...
Namespace Example
	Friend Class Program
		...
		''' <summary>
		''' Convert XLSX to HTML (file to file).
		''' </summary>
		''' <remarks>
		''' Details: https://sautinsoft.com/products/excel/help/net/developer-guide/convert-xlsx-to-html-in-csharp-vb.php
		''' </remarks>
		...
		''' <summary>
		''' Convert XLSX to HTML (using Stream).
		''' </summary>
		''' <remarks>
		''' Details: https://sautinsoft.com/products/excel/help/net/developer-guide/convert-xlsx-to-html-in-csharp-vb.php
		''' </remarks>
