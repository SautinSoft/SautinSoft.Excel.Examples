...
Namespace Example
	Friend Class Program
		...
		''' <summary>
		''' Convert XLSX to PDF (file to file).
		''' </summary>
		''' <remarks>
		''' Details: https://sautinsoft.com/products/excel/help/net/developer-guide/convert-xlsx-to-pdf-in-csharp-vb.php
		''' </remarks>
		...
		''' <summary>
		''' Convert XLSX to PDF (using Stream).
		''' </summary>
		''' <remarks>
		''' Details: https://sautinsoft.com/products/excel/help/net/developer-guide/convert-xlsx-to-pdf-in-csharp-vb.php
		''' </remarks>
